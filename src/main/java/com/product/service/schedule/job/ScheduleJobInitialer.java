    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        try {
            ...
            scheduleJobManager.addJob(ScheduleJobEnum.PRODUCT_SCHEDULE_JOB_1.getJobName(), ScheduleJobEnum.PRODUCT_SCHEDULE_JOB_1.getJobGroupName(),
                    ...
                    scheduleJobConfig.getScheduleJobOneCron(), ScheduleJob.class, "executeScheduleJobOne");
...
//                    scheduleJobConfig.getScheduleJobTwoCron(), ScheduleJob.class, "executeScheduleJobTwo");
...
//                    scheduleJobConfig.getScheduleJobThreeCron(), ScheduleJob.class, "executeScheduleJobThree");
...
//                    ScheduleJobEnum.DELETE_HOUSEKEEP_SUMMARY_RECORD_JOB.getDescription(), scheduleJobConfig.getDeleteHousekeepSummaryRecordJobCron(), ScheduleJob.class,
//                    "executeDeleteHousekeepSummaryRecordJob");
//            scheduleJobManager.scheduleUpdateCorn(ScheduleJobEnum.DELETE_HOUSEKEEP_SUMMARY_RECORD_JOB.getTriggerName(), ScheduleJobEnum.DELETE_HOUSEKEEP_SUMMARY_RECORD_JOB.getTriggerGroupName(),
...
//                    ScheduleJobEnum.ARCHIVE_DATABASE_RECORD_JOB.getDescription(), scheduleJobConfig.getArchiveActiveTableRecordJobCron(), ScheduleJob.class, "executeArchiveDatabaseRecordJob");
